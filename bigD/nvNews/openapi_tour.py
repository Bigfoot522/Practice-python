...
ServiceKey = '85V8v25j6zW8VlD%2BlPETXk6qm5U7KisH6QRMmzEToRQeXZxFqfXPJ3bJTfGccn1ZZ5F6tEWhpRCX5IGoZdSn%2BQ%3D%3D'
...
def getTourismStatsService(nat_cd, ed_cd, nStartYear, nEndYear):
    ...
    result = []
    natName = ''
    dataEND = "{0}{1:0>2}".format(str(nEndYear+1), str(12))
    isDataEnd = 0
